...
# 環境変数を直接設定
export APP_BASE_PATH="/dev-app1"
export ASPNETCORE_ENVIRONMENT="Production"
export REPLIT_DEPLOYMENT="true"

# 1. ヘルスチェック設定確認
echo "ヘルスチェックエンドポイント設定を確認中..."
if grep -q "/dev-app1/health" Program.cs; then
echo "✅ Replit用ヘルスチェック設定済み (/dev-app1/health専用)"
echo "指定されたヘルスチェックエンドポイント: https://[replit-domain]/dev-app1/health"
else
